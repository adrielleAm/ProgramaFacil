        ...
        <div class="col-md-12">
          <form method="POST" id="formCliente" action="coletor.php" class="form-group w-100 m-1 p-2 bg-light border border-primary" draggable="true">
            <div class="form-group w-100" > <h6><b>Nome do projeto:</b><h6>
              <input  type="text" name="nomeProjeto" id="nomeProjeto" size="60" class="form-control"> </div>
            <hr>
            <h6 ><b>Descrição do projetos:</b></h6>
            <p><b>Faça uma pequena descrição do projeto.</b></p>
            <textarea name="descProjeto" id="descProjeto" cols="15" rows="5" class="form-control-lg w-100"></textarea>
            <hr>
            ...
            <br>
            <h6><b>Outras...</b></h6>
            <textarea name="outrosProjetos"  name="outrosProjetos" id="outrosProjetos" cols="7" rows="3" class="form-control-lg w-100" ></textarea>
            <br>
            <hr>
            ...
            <br>
            <h6><b>Outras...</b></h6>
            <textarea name="outrosPlataformas"  id="outrosPlataformas" name="outrosPlataformas" cols="7" rows="3" class="form-control-lg w-100"></textarea>
            <br>
            <hr>
            ...
            <input type="hidden" value="incluirProjeto" name="acao">
          </form>
        </div>
      </div>
    </div>
